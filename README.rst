...
from [GitHub Releases](https://github.com/wxGlade/wxGlade/releases) or 
[SourceForge](https://sourceforge.net/projects/wxglade/).
Once download unzip it to a **known** location, *possibly one on your path or that
you add to the path*.

If you have a single version of python installed you may wish to consider adding a desktop
shortcut to run the wxGlade.py file, (or the wxGlade.pyw file). 
*See your operating system instructions on how to do this.* If you have more 
than one version of python installed you will need to add shortcuts for each version 
that you wish to run wxGlade with or use the command line as below.
...
required to start a python application on your platform. *If you set up a desktop shortcut 
