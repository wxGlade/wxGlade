    ...
    wxFrame(parent, id, title, pos, size, style)
{
    ...
    frame_1_toolbar->AddTool(wxID_UP, "UpDown", wxArtProvider::GetBitmap(wxART_GO_UP, wxART_OTHER, wxSize(32, 32)), wxArtProvider::GetBitmap(wxART_GO_DOWN, wxART_OTHER, wxSize(32, 32)), wxITEM_CHECK, "Up or Down", "Up or Down");
