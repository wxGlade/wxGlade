    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    list_box_1 = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, list_box_1_choices);
    ...
    list_box_2 = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, list_box_2_choices);
