...
class PyOgg2_MyFrame(wx.Frame):
    ...
    def __do_layout(self):
        ...
        _gszr_pane1.Add(self.text_ctrl_1, 1, wx.ALL | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        _gszr_pane4.Add(self._lbl_output_filename, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
...
class MyFrameGrid(wx.Frame):
    ...
    def __do_layout(self):
        ...
        self.grid_sizer.Add(self.button, 0, wx.ALL | wx.ALIGN_RIGHT, 5)
