...
(defclass MyFrameGrid()
        ...
        (sizer :initform nil :accessor slot-sizer)))
...
(defmethod do-layout ((obj MyFrameGrid))
        ...
        (setf (slot-sizer obj) (wxBoxSizer_Create wxVERTICAL))
        ...
        (wxSizer_AddSizer (slot-sizer obj) (slot-grid-sizer obj) 1 wxEXPAND 0 nil)
        (wxWindow_SetSizer (slot-top-window obj) (slot-sizer obj))
        (wxSizer_SetSizeHints (slot-slot-sizer obj) (slot-top-window obj))
