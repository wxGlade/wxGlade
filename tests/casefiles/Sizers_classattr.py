...
class MyDialog(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        self.sizer_3 = wx.StaticBoxSizer(self.sizer_3_staticbox, wx.HORIZONTAL)
        self.sizer_4 = wx.FlexGridSizer(4, 1, 0, 0)
        self.sizer_2_staticbox.Lower()
        self.sizer_2 = wx.StaticBoxSizer(self.sizer_2_staticbox, wx.HORIZONTAL)
        ...
        self.grid_sizer_2.Add(self.sizer_4, 1, wx.EXPAND | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        self.grid_sizer_1.Add(self.sizer_1, 1, wx.EXPAND | wx.ALIGN_RIGHT, 0)
