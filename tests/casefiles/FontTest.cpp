    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    text_ctrl_1->SetFont(wxFont(16, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, 0, ""));
    ...
    label_2->SetFont(wxFont(8, wxFONTFAMILY_DECORATIVE, wxFONTSTYLE_SLANT, wxFONTWEIGHT_LIGHT, 0, ""));
    sizer_1->Add(label_2, 0, 0, 0);
    wxStaticText* label_3 = new wxStaticText(this, wxID_ANY, "label_3");
    label_3->SetFont(wxFont(8, wxFONTFAMILY_ROMAN, wxFONTSTYLE_ITALIC, wxFONTWEIGHT_BOLD, 0, ""));
    sizer_1->Add(label_3, 0, 0, 0);
    wxStaticText* label_4 = new wxStaticText(this, wxID_ANY, "label_4");
    label_4->SetFont(wxFont(8, wxFONTFAMILY_SCRIPT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, 0, ""));
    sizer_1->Add(label_4, 0, 0, 0);
    wxStaticText* label_5 = new wxStaticText(this, wxID_ANY, "label_5");
    label_5->SetFont(wxFont(10, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, 0, ""));
    sizer_1->Add(label_5, 0, 0, 0);
    wxStaticText* label_6 = new wxStaticText(this, wxID_ANY, "label_6");
    label_6->SetFont(wxFont(12, wxFONTFAMILY_MODERN, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, 1, ""));
