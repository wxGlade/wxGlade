...
"Method creates the objects contained in the class."
	...
	;;; Tool Bar
        (setf (slot-Mp3-To-Ogg-toolbar obj) (wxToolBar_Create (slot-top-window obj) -1 -1 -1 -1 -1 (logior wxTB_TEXT wxTB_HORIZONTAL)))
...
(defmethod set-properties ((obj PyOgg2_MyFrame))
        ...
        (slot-top-window obj).wxWindow_SetSize((1160, 765))
...
(defmethod do-layout ((obj PyOgg2_MyFrame))
        ...
        (wxSizer_AddWindow (slot--gszr-pane1 obj) (slot--lbl-input-filename obj) 0 (logior wxALL wxALIGN_CENTER_VERTICAL) 5 nil)
        (wxSizer_AddWindow (slot--gszr-pane1 obj) (slot-text-ctrl-1 obj) 1 (logior wxALL wxEXPAND wxALIGN_CENTER_VERTICAL) 5 nil)
        ...
        (wxSizer_AddWindow (slot--gszr-pane4 obj) (slot--lbl-output-filename obj) 0 (logior wxALL wxALIGN_CENTER_VERTICAL) 5 nil)
...
"Method creates the objects contained in the class."
        ...
        (setf (slot-static-line obj) (wxStaticLine_Create (slot-top-window obj) wxID_ANY -1 -1 -1 -1 0))
...
(defmethod do-layout ((obj MyFrameGrid))
        ...
        (wxSizer_AddWindow (slot-grid-sizer obj) (slot-button obj) 0 (logior wxALL wxALIGN_RIGHT) 5 nil)
