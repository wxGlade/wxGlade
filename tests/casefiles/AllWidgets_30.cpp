    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    timepicker_ctrl_1 = new wxTimePickerCtrl(notebook_1_wxDatePickerCtrl, wxID_ANY, wxDefaultDateTime, wxDefaultPosition, wxDefaultSize, wxTP_DEFAULT);
    ...
    radio_btn_1 = new wxRadioButton(sizer_8->GetStaticBox(), wxID_ANY, _("Alice"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
    grid_sizer_2->Add(radio_btn_1, 1, wxALL|wxEXPAND, 5);
    text_ctrl_1 = new wxTextCtrl(sizer_8->GetStaticBox(), wxID_ANY, wxEmptyString);
    grid_sizer_2->Add(text_ctrl_1, 1, wxALL|wxEXPAND, 5);
    radio_btn_2 = new wxRadioButton(sizer_8->GetStaticBox(), wxID_ANY, _("Bob"));
    grid_sizer_2->Add(radio_btn_2, 1, wxALL|wxEXPAND, 5);
    text_ctrl_2 = new wxTextCtrl(sizer_8->GetStaticBox(), wxID_ANY, wxEmptyString);
    grid_sizer_2->Add(text_ctrl_2, 1, wxALL|wxEXPAND, 5);
    radio_btn_3 = new wxRadioButton(sizer_8->GetStaticBox(), wxID_ANY, _("Malroy"));
    grid_sizer_2->Add(radio_btn_3, 1, wxALL|wxEXPAND, 5);
    text_ctrl_3 = new wxTextCtrl(sizer_8->GetStaticBox(), wxID_ANY, wxEmptyString);
    ...
    wxStaticText* label_5 = new wxStaticText(notebook_1_wxStaticText, wxID_ANY, _("green on pink (RGB)"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL);
