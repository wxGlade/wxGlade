...
"Method creates the objects contained in the class."
        ...
        (setf (slot-top-window obj) (wxDialog_create nil -1 "" -1 -1 -1 -1 wxDEFAULT_DIALOG_STYLE))
        ...
        (setf (slot-use-menu-icons obj) (wxCheckBox_Create (slot-notebook-1-pane-1 obj) -1 _("Use icons in menu items") -1 -1 -1 -1 0))
        (setf (slot-frame-tool-win obj) (wxCheckBox_Create (slot-notebook-1-pane-1 obj) -1 _("Show properties and tree windows as small frames") -1 -1 -1 -1 0))
        (setf (slot-show-progress obj) (wxCheckBox_Create (slot-notebook-1-pane-1 obj) -1 _("Show progress dialog when loading wxg files") -1 -1 -1 -1 0))
        (setf (slot-remember-geometry obj) (wxCheckBox_Create (slot-notebook-1-pane-1 obj) -1 _("Remember position and size of wxGlade windows") -1 -1 -1 -1 0))
        (setf (slot-show-sizer-handle obj) (wxCheckBox_Create (slot-notebook-1-pane-1 obj) -1 _("Show \"handles\" of sizers") -1 -1 -1 -1 0))
        (setf (slot-use-kde-dialogs obj) (wxCheckBox_Create (slot-notebook-1-pane-1 obj) -1 _("Use native file dialogs on KDE") -1 -1 -1 -1 0))
        (setf (slot-open-save-path obj) (wxTextCtrl_Create (slot-notebook-1-pane-1 obj) -1 "" -1 -1 -1 -1 0))
        (setf (slot-codegen-path obj) (wxTextCtrl_Create (slot-notebook-1-pane-1 obj) -1 "" -1 -1 -1 -1 0))
        (setf (slot-number-history obj) (wxSpinCtrl_Create (slot-notebook-1-pane-1 obj) -1 4 -1 -1 -1 -1 wxSP_ARROW_KEYS 0 100 4))
        (setf (slot-buttons-per-row obj) (wxSpinCtrl_Create (slot-notebook-1-pane-1 obj) -1 5 -1 -1 -1 -1 wxSP_ARROW_KEYS 1 100 5))
        (setf (slot-use-dialog-units obj) (wxCheckBox_Create (slot-notebook-1-pane-2 obj) -1 _("Use dialog units by default for size properties") -1 -1 -1 -1 0))
        (setf (slot-wxg-backup obj) (wxCheckBox_Create (slot-notebook-1-pane-2 obj) -1 _("Create backup wxg files") -1 -1 -1 -1 0))
        (setf (slot-codegen-backup obj) (wxCheckBox_Create (slot-notebook-1-pane-2 obj) -1 _("Create backup files for generated source") -1 -1 -1 -1 0))
        (setf (slot-allow-duplicate-names obj) (wxCheckBox_Create (slot-notebook-1-pane-2 obj) -1 _("Allow duplicate widget names") -1 -1 -1 -1 0))
        (setf (slot-default-border obj) (wxCheckBox_Create (slot-notebook-1-pane-2 obj) -1 _("Default border width for widgets") -1 -1 -1 -1 0))
        (setf (slot-default-border-size obj) (wxSpinCtrl_Create (slot-notebook-1-pane-2 obj) -1  -1 -1 -1 -1 wxSP_ARROW_KEYS 0 20 ))
        (setf (slot-autosave obj) (wxCheckBox_Create (slot-notebook-1-pane-2 obj) -1 _("Auto save wxg files every ") -1 -1 -1 -1 0))
        (setf (slot-autosave-delay obj) (wxSpinCtrl_Create (slot-notebook-1-pane-2 obj) -1 120 -1 -1 -1 -1 wxSP_ARROW_KEYS 30 300 120))
        (setf (slot-write-timestamp obj) (wxCheckBox_Create (slot-notebook-1-pane-2 obj) -1 _("Insert timestamp on generated source files") -1 -1 -1 -1 0))
        (setf (slot-write-generated-from obj) (wxCheckBox_Create (slot-notebook-1-pane-2 obj) -1 _("Insert .wxg file name on generated source files") -1 -1 -1 -1 0))
        (setf (slot-backup-suffix obj) (wxRadioBox_Create (slot-notebook-1-pane-2 obj) -1 _("Backup options") -1 -1 -1 -1 2 (vector _("append ~ to filename") _("append .bak to filename")) 2 wxRA_SPECIFY_COLS))
        (setf (slot-local-widget-path obj) (wxTextCtrl_Create (slot-notebook-1-pane-2 obj) -1 "" -1 -1 -1 -1 0))
        (setf (slot-choose-widget-path obj) (wxButton_Create (slot-notebook-1-pane-2 obj) -1 _("...") -1 -1 -1 -1 wxBU_EXACTFIT))
...
(defmethod do-layout ((obj wxGladePreferencesUI))
        ...
        (setf (slot-label-1 obj) (wxStaticText_Create (slot-notebook-1-pane-1 obj) -1 _("Initial path for \nfile opening/saving dialogs:") -1 -1 -1 -1 0))
        ...
        (setf (slot-label-2-copy obj) (wxStaticText_Create (slot-notebook-1-pane-1 obj) -1 _("Initial path for \ncode generation file dialogs:") -1 -1 -1 -1 0))
        ...
        (setf (slot-label-2 obj) (wxStaticText_Create (slot-notebook-1-pane-1 obj) -1 _("Number of items in file history") -1 -1 -1 -1 0))
        ...
        (setf (slot-label-2-copy-1 obj) (wxStaticText_Create (slot-notebook-1-pane-1 obj) -1 _("Number of buttons per row\nin the main palette") -1 -1 -1 -1 0))
        ...
        (setf (slot-label-3 obj) (wxStaticText_Create (slot-notebook-1-pane-2 obj) -1 _(" seconds") -1 -1 -1 -1 0))
