#!/usr/bin/env lisp
;;;
;;; generated by wxGlade 3f8c15d57d22+ on Tue Jun 23 18:20:54 2015
;;;
...
(defclass All_Widgets_Frame()
        ...
        (bitmap-code-emptybitmap :initform nil :accessor slot-bitmap-code-emptybitmap)
...
"Method creates the objects contained in the class."
        ...
        (wxMenu_Append wxglade_tmp_menu wxID_OPEN (_"Exit") (_"Finish program") 0)
	...
	;;; Tool Bar
        ...
        (setf (slot-choice-empty obj) (wxChoice_Create (slot-notebook-1-wxChoice obj) wxID_ANY -1 -1 -1 -1 1 (vector (_"<set by wxGlade>"))  0))
        ...
        (setf (slot-combo-box-empty obj) (wxComboBox_Create (slot-notebook-1-wxComboBox obj) wxID_ANY "" -1 -1 -1 -1 1 (vector (_"<set by wxGlade>")) wxCB_DROPDOWN))
        ...
        (setf (slot-list-box-empty obj) (wxListBox_Create (slot-notebook-1-wxListBox obj) wxID_ANY -1 -1 -1 -1 1 (vector (_"<set by wxGlade>")) wxLB_SINGLE))
        ...
        (setf (slot-radio-box-empty1 obj) (wxRadioBox_Create (slot-notebook-1-wxRadioBox obj) wxID_ANY (_"radio_box_empty1") -1 -1 -1 -1 1 (vector (_"<set by wxGlade>")) 0 wxRA_SPECIFY_ROWS))
        ...
        (setf (slot-radio-box-empty2 obj) (wxRadioBox_Create (slot-notebook-1-wxRadioBox obj) wxID_ANY (_"radio_box_empty2") -1 -1 -1 -1 1 (vector (_"<set by wxGlade>")) 0 wxRA_SPECIFY_COLS))
        ...
        (setf (slot-slider-1 obj) (wxSlider_Create (slot-notebook-1-wxSlider obj) wxID_ANY 5 0 10 -1 -1 -1 -1 wxSL_HORIZONTAL))
        ...
        (setf (slot-splitter-1 obj) (wxSplitterWindow_Create (slot-notebook-1-wxSplitterWindow-horizontal obj) wxID_ANY -1 -1 -1 -1 wxSP_3D))
        ...
        (setf (slot-splitter-2 obj) (wxSplitterWindow_Create (slot-notebook-1-wxSplitterWindow-vertical obj) wxID_ANY -1 -1 -1 -1 wxSP_3D))
        ...
        (setf (slot-bitmap-code-emptybitmap obj) (wxStaticBitmap_Create (slot-notebook-1-wxStaticBitmap obj) wxID_ANY  wxBitmap_Create(32 32) -1 -1 -1 -1 0))
        ...
        (setf (slot-tree-ctrl-1 obj) (wxTreeCtrl_Create (slot-notebook-1-wxTreeCtrl obj) wxID_ANY -1 -1 -1 -1 wxTR_HAS_BUTTONS))
...
(defmethod set-properties ((obj All_Widgets_Frame))
        ...
        (wxChoice_SetSelection (slot-choice-empty obj) 0)
        (wxChoice_SetSelection (slot-choice-filled obj) 1)
        (wxComboBox_SetSelection (slot-combo-box-empty obj) -1)
        ...
        (wxListBox_SetSelection (slot-list-box-empty obj) 0)
        (wxListBox_SetSelection (slot-list-box-filled obj) 1)
        (wxRadioBox_SetSelection (slot-radio-box-empty1 obj) 0)
        (wxRadioBox_SetSelection (slot-radio-box-filled1 obj) 1)
        (wxRadioBox_SetSelection (slot-radio-box-empty2 obj) 0)
...
(defmethod do-layout ((obj All_Widgets_Frame))
        ...
        (wxSizer_AddWindow (slot-sizer-11 obj) (slot-bitmap-code-emptybitmap obj) 1 (logior wxALIGN_CENTER wxALL wxEXPAND) 5 nil)
