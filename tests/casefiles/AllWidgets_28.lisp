...
(defclass All_Widgets_Frame()
        ...
        (bitmap-button-empy2 :initform nil :accessor slot-bitmap-button-empy2)
...
"Method creates the objects contained in the class."
	...
	;;; Tool Bar
        ...
        (setf (slot-bitmap-button-empy2 obj) (wxBitmapButton_Create (slot-notebook-1-wxBitmapButton obj) wxID_ANY wxBitmap_Create(20 20) -1 -1 -1 -1 (logior wxBORDER_NONE wxBU_BOTTOM)))
...
(defmethod set-properties ((obj All_Widgets_Frame))
        ...
        (slot-top-window obj).wxWindow_SetSize((800, 400))
        ...
        (slot-bitmap-button-empy2 obj).wxWindow_SetSize((slot-bitmap-button-empy2 obj).wxWindow_GetBestSize())
        (wxButton_SetDefault (slot-bitmap-button-empy2 obj))
...
(defmethod do-layout ((obj All_Widgets_Frame))
        ...
        (wxSizer_AddWindow (slot-sizer-13 obj) (slot-bitmap-button-empy2 obj) 1 (logior wxALL wxEXPAND) 5 nil)
