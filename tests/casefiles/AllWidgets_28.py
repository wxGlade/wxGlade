...
class All_Widgets_Frame(wx.Frame):
    ...
    def __do_layout(self):
        ...
        sizer_16.Add(self.spin_button_1, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL | wx.ALL | wx.EXPAND, 5)
