...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 90cf0753a092+ on Thu Nov 10 20:57:48 2016
#
...
class PyOgg2_MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_item = wxglade_tmp_menu.Append(wx.ID_OPEN, _("&Open"), "")
        self.Bind(wx.EVT_MENU, self.OnOpen, id=wxglade_tmp_item.GetId())
        wxglade_tmp_item = wxglade_tmp_menu.Append(wx.ID_EXIT, _("&Quit"), "")
        self.Bind(wx.EVT_MENU, self.OnClose, id=wxglade_tmp_item.GetId())
        self.Mp3_To_Ogg_menubar.Append(wxglade_tmp_menu, _("&File"))
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_item = wxglade_tmp_menu.Append(wx.ID_ABOUT, _("&About"), _("About dialog"))
        self.Bind(wx.EVT_MENU, self.OnAboutDialog, id=wxglade_tmp_item.GetId())
