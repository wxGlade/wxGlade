...
sub new {
        ...
        $self->{use_menu_icons} = Wx::CheckBox->new($self->{notebook_1_pane_1}, wxID_ANY, _T("Use icons in menu items"), wxDefaultPosition, wxDefaultSize, );
        $self->{frame_tool_win} = Wx::CheckBox->new($self->{notebook_1_pane_1}, wxID_ANY, _T("Show properties and tree windows as small frames"), wxDefaultPosition, wxDefaultSize, );
        $self->{show_progress} = Wx::CheckBox->new($self->{notebook_1_pane_1}, wxID_ANY, _T("Show progress dialog when loading wxg files"), wxDefaultPosition, wxDefaultSize, );
        $self->{remember_geometry} = Wx::CheckBox->new($self->{notebook_1_pane_1}, wxID_ANY, _T("Remember position and size of wxGlade windows"), wxDefaultPosition, wxDefaultSize, );
        $self->{show_sizer_handle} = Wx::CheckBox->new($self->{notebook_1_pane_1}, wxID_ANY, _T("Show \"handles\" of sizers"), wxDefaultPosition, wxDefaultSize, );
        $self->{use_kde_dialogs} = Wx::CheckBox->new($self->{notebook_1_pane_1}, wxID_ANY, _T("Use native file dialogs on KDE"), wxDefaultPosition, wxDefaultSize, );
        $self->{open_save_path} = Wx::TextCtrl->new($self->{notebook_1_pane_1}, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, );
        $self->{codegen_path} = Wx::TextCtrl->new($self->{notebook_1_pane_1}, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, );
        ...
        $self->{use_dialog_units} = Wx::CheckBox->new($self->{notebook_1_pane_2}, wxID_ANY, _T("Use dialog units by default for size properties"), wxDefaultPosition, wxDefaultSize, );
        $self->{wxg_backup} = Wx::CheckBox->new($self->{notebook_1_pane_2}, wxID_ANY, _T("Create backup wxg files"), wxDefaultPosition, wxDefaultSize, );
        $self->{codegen_backup} = Wx::CheckBox->new($self->{notebook_1_pane_2}, wxID_ANY, _T("Create backup files for generated source"), wxDefaultPosition, wxDefaultSize, );
        $self->{allow_duplicate_names} = Wx::CheckBox->new($self->{notebook_1_pane_2}, wxID_ANY, _T("Allow duplicate widget names"), wxDefaultPosition, wxDefaultSize, );
        $self->{default_border} = Wx::CheckBox->new($self->{notebook_1_pane_2}, wxID_ANY, _T("Default border width for widgets"), wxDefaultPosition, wxDefaultSize, );
        ...
        $self->{autosave} = Wx::CheckBox->new($self->{notebook_1_pane_2}, wxID_ANY, _T("Auto save wxg files every "), wxDefaultPosition, wxDefaultSize, );
        ...
        $self->{write_timestamp} = Wx::CheckBox->new($self->{notebook_1_pane_2}, wxID_ANY, _T("Insert timestamp on generated source files"), wxDefaultPosition, wxDefaultSize, );
        $self->{write_generated_from} = Wx::CheckBox->new($self->{notebook_1_pane_2}, wxID_ANY, _T("Insert .wxg file name on generated source files"), wxDefaultPosition, wxDefaultSize, );
        ...
        $self->{local_widget_path} = Wx::TextCtrl->new($self->{notebook_1_pane_2}, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, );
...
sub __do_layout {
        ...
        my $label_2 = Wx::StaticText->new($self->{notebook_1_pane_1}, wxID_ANY, _T("Number of items in file history"), wxDefaultPosition, wxDefaultSize, );
        ...
        my $label_3 = Wx::StaticText->new($self->{notebook_1_pane_2}, wxID_ANY, _T(" seconds"), wxDefaultPosition, wxDefaultSize, );
