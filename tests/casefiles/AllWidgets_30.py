...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 90cf0753a092+ on Thu Nov 10 20:58:44 2016
#
...
class All_Widgets_Frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.AppendSeparator()
        item = self.All_Widgets_menubar.mn_RemoveTabs = wx.MenuItem(wxglade_tmp_menu, wx.ID_ANY, _("Remove Tabs"), _("Remove all leading tabs"), wx.ITEM_CHECK)
        wxglade_tmp_menu.AppendItem(self.All_Widgets_menubar.mn_RemoveTabs)
        self.Bind(wx.EVT_MENU, self.onRemoveTabs, id=item.GetId())
        ...
        wxglade_tmp_menu.AppendSeparator()
        item = wxglade_tmp_menu.Append(wx.ID_ABOUT, _("About"), _("Show the About dialog"), wx.ITEM_NORMAL)
