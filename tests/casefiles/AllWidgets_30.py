...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 6e98cb8b302d+ on Sat Nov 19 22:04:03 2016
#
...
class All_Widgets_Frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(wx.ID_OPEN, _("&Open"), _("Open an existing document"), wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.ID_CLOSE, _("&Close file"), _("Close current document"), wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        wxglade_tmp_menu.Append(wx.ID_EXIT, _("E&xit"), _("Finish program"), wx.ITEM_NORMAL)
        self.All_Widgets_menubar.Append(wxglade_tmp_menu, _("&File"))
        wxglade_tmp_menu = wx.Menu()
        self.All_Widgets_menubar.mn_Unix = wx.MenuItem(wxglade_tmp_menu, wx.ID_ANY, _("Unix"), _("Use Unix line endings"), wx.ITEM_RADIO)
        ...
        self.All_Widgets_menubar.mn_Windows = wx.MenuItem(wxglade_tmp_menu, wx.ID_ANY, _("Windows"), _("Use Windows line endings"), wx.ITEM_RADIO)
        ...
        wxglade_tmp_menu.AppendSeparator()
        self.All_Widgets_menubar.mn_RemoveTabs = wx.MenuItem(wxglade_tmp_menu, wx.ID_ANY, _("Remove Tabs"), _("Remove all leading tabs"), wx.ITEM_CHECK)
        wxglade_tmp_menu.AppendItem(self.All_Widgets_menubar.mn_RemoveTabs)
        ...
        wxglade_tmp_menu = wx.Menu()
        item = wxglade_tmp_menu.Append(wx.ID_HELP, _("Manual"), _("Show the application manual"), wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.onShowManual, id=item.GetId())
        wxglade_tmp_menu.AppendSeparator()
        wxglade_tmp_menu.Append(wx.ID_ABOUT, _("About"), _("Show the About dialog"), wx.ITEM_NORMAL)
