...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.1RC1 on Tue Nov 10 21:07:04 2015
#
...
class All_Widgets_Frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu = wx.Menu()
        self.mn_Unix = wx.MenuItem(wxglade_tmp_menu, wx.ID_ANY, _("Unix"), _("Use Unix line endings"), wx.ITEM_RADIO)
        wxglade_tmp_menu.AppendItem(self.mn_Unix)
        self.mn_Windows = wx.MenuItem(wxglade_tmp_menu, wx.ID_ANY, _("Windows"), _("Use Windows line endings"), wx.ITEM_RADIO)
        ...
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.ID_HELP, _("Manual"), _("Show the application manual"), wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
