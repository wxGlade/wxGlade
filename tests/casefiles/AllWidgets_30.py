...
class All_Widgets_Frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(wx.ID_OPEN, _("Exit"), _("Finish program"), wx.ITEM_NORMAL)
        ...
        self.bitmap_button_empy2 = wx.BitmapButton(self.notebook_1_wxBitmapButton, wx.ID_ANY, wx.EmptyBitmap(20, 20), style=wx.BORDER_NONE | wx.BU_BOTTOM)
        ...
        self.choice_empty = wx.Choice(self.notebook_1_wxChoice, wx.ID_ANY, choices=[_("<set by wxGlade>")])
        ...
        self.combo_box_empty = wx.ComboBox(self.notebook_1_wxComboBox, wx.ID_ANY, choices=[_("<set by wxGlade>")], style=wx.CB_DROPDOWN)
        ...
        self.list_box_empty = wx.ListBox(self.notebook_1_wxListBox, wx.ID_ANY, choices=[_("<set by wxGlade>")])
        ...
        self.radio_box_empty1 = wx.RadioBox(self.notebook_1_wxRadioBox, wx.ID_ANY, _("radio_box_empty1"), choices=[_("<set by wxGlade>")], majorDimension=0, style=wx.RA_SPECIFY_ROWS)
        ...
        self.radio_box_empty2 = wx.RadioBox(self.notebook_1_wxRadioBox, wx.ID_ANY, _("radio_box_empty2"), choices=[_("<set by wxGlade>")], majorDimension=0, style=wx.RA_SPECIFY_COLS)
        ...
        self.bitmap_code_emptybitmap = wx.StaticBitmap(self.notebook_1_wxStaticBitmap, wx.ID_ANY, wx.EmptyBitmap(32, 32))
    ...
    def __do_layout(self):
        ...
        sizer_13.Add(self.bitmap_button_empy2, 1, wx.ALL | wx.EXPAND, 5)
        ...
        sizer_11.Add(self.bitmap_code_emptybitmap, 1, wx.ALIGN_CENTER | wx.ALL | wx.EXPAND, 5)
...
if __name__ == "__main__":
    ...
    AllWidgets30App = wx.PySimpleApp(0)
