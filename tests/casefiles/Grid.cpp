    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    grid_1->SetLabelFont(wxFont(14, wxMODERN, wxNORMAL, wxNORMAL, 0, ""));
    grid_1->SetDefaultCellFont(wxFont(12, wxSWISS, wxNORMAL, wxNORMAL, 0, ""));
    grid_1->SetGridLineColour(wxColour(255, 0, 0));
    grid_1->SetLabelBackgroundColour(wxColour(216, 191, 216));
    grid_1->SetColLabelValue(0, "Column A");
    grid_1->SetColLabelValue(1, "Column B");
...
void MyFrame::myEVT_GRID_CELL_LEFT_CLICK(wxGridEvent &event)  // wxGlade: MyFrame.<event_handler>
{
    ...
    wxLogDebug("Event handler (MyFrame::myEVT_GRID_CELL_LEFT_CLICK) not implemented yet");
}
