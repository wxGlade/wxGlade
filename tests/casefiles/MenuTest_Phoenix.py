...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.2 on Tue Aug 08 23:39:49 2017
#
...
class MenuTestFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(wx.ID_OPEN, "&Open", "Stock ID", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.ID_HELP, "Manual", "Stock ID, handler", wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.onShowManual, id=wx.ID_HELP)
        self.test_menubar.m_Close = wxglade_tmp_menu.Append(wx.ID_CLOSE, "&Close file", "Stock ID, name, handler", wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.onCloseFile, id=wx.ID_CLOSE)
        self.test_menubar.m_Exit = wxglade_tmp_menu.Append(wx.ID_EXIT, "E&xit", "Stock ID, name", wx.ITEM_NORMAL)
        ...
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(mn_ID1, "Named 1", "Named ID", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(mn_ID2, "Named 2", "Named ID, handler", wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.on_named2, id=mn_ID2)
        self.test_menubar.m_named = wxglade_tmp_menu.Append(mn_ID3, "Named 3", "Named ID, name, handler", wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.on_named3, id=mn_ID3)
        self.test_menubar.m_named4 = wxglade_tmp_menu.Append(mn_ID4, "Named 4", "Named ID, name", wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        ...
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.ID_ANY, "Auto 1", "Auto ID", wx.ITEM_NORMAL)
        item = wxglade_tmp_menu.Append(wx.ID_ANY, "Auto 2", "Auto ID, handler", wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.on_auto2, id=item.GetId())
        self.test_menubar.m_auto3 = wxglade_tmp_menu.Append(wx.ID_ANY, "Auto 3", "Auto ID, name, handler", wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.on_auto3, id=self.test_menubar.m_auto3.GetId())
        self.test_menubar.m_auto4 = wxglade_tmp_menu.Append(wx.ID_ANY, "Auto 4", "Auto ID, name", wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        ...
        self.Bind(wx.EVT_MENU, self.on_auto3, id=self.test_menubar.m_auto3C.GetId())
        ...
        self.Bind(wx.EVT_MENU, self.on_auto3, id=self.test_menubar.m_auto3R.GetId())
        ...
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.NewId(), "Minus1 1", "Minus1 ID", wx.ITEM_NORMAL)
        item = wxglade_tmp_menu.Append(wx.NewId(), "Minus1 2", "Minus1 ID, handler", wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.on_Minus12, id=item.GetId())
        self.test_menubar.m_Minus13 = wxglade_tmp_menu.Append(wx.NewId(), "Minus1 3", "Minus1 ID, name, handler", wx.ITEM_NORMAL)
        self.Bind(wx.EVT_MENU, self.on_Minus13, id=self.test_menubar.m_Minus13.GetId())
        self.test_menubar.m_Minus14 = wxglade_tmp_menu.Append(wx.NewId(), "Minus1 4", "Minus1 ID, name", wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        ...
        self.Bind(wx.EVT_MENU, self.on_Minus13, id=self.test_menubar.m_Minus13C.GetId())
        ...
        self.Bind(wx.EVT_MENU, self.on_Minus13, id=self.test_menubar.m_Minus13R.GetId())
