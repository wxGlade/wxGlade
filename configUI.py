...
class wxGladePreferencesUI(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.sizer_6_staticbox = wx.StaticBox(self.notebook_1_pane_2, -1, "Local widget path")
        self.notebook_1_pane_1 = wx.Panel(self.notebook_1, -1)
        self.use_menu_icons = wx.CheckBox(self.notebook_1_pane_1, -1, "Use icons in menu items")
        self.frame_tool_win = wx.CheckBox(self.notebook_1_pane_1, -1, "Show properties and tree windows as small frames (Win32 only)")
        self.show_progress = wx.CheckBox(self.notebook_1_pane_1, -1, "Show progress dialog when loading wxg files")
        self.remember_geometry = wx.CheckBox(self.notebook_1_pane_1, -1, "Remember position and size of wxGlade windows")
        self.show_sizer_handle = wx.CheckBox(self.notebook_1_pane_1, -1, "Show \"handles\" of sizers")
        self.use_kde_dialogs = wx.CheckBox(self.notebook_1_pane_1, -1, "Use native file dialogs on KDE")
        ...
        self.use_dialog_units = wx.CheckBox(self.notebook_1_pane_2, -1, "Use dialog units by default for size properties")
        self.wxg_backup = wx.CheckBox(self.notebook_1_pane_2, -1, "Create backup wxg files")
        self.codegen_backup = wx.CheckBox(self.notebook_1_pane_2, -1, "Create backup files for generated source")
        self.allow_duplicate_names = wx.CheckBox(self.notebook_1_pane_2, -1, "Allow duplicate widget names")
        self.default_border = wx.CheckBox(self.notebook_1_pane_2, -1, "Default border width for widgets")
        self.default_border_size = wx.SpinCtrl(self.notebook_1_pane_2, -1, "", min=0, max=20)
        self.autosave = wx.CheckBox(self.notebook_1_pane_2, -1, "Auto save wxg files every ")
        self.autosave_delay = wx.SpinCtrl(self.notebook_1_pane_2, -1, "120", min=30, max=300)
        self.backup_suffix = wx.RadioBox(self.notebook_1_pane_2, -1, "Backup options", choices=["append ~ to filename", "append .bak to filename"], majorDimension=2, style=wx.RA_SPECIFY_COLS)
    ...
    def __do_layout(self):
        ...
        label_1 = wx.StaticText(self.notebook_1_pane_1, -1, "Initial path for \nfile opening/saving dialogs:")
        ...
        label_2_copy = wx.StaticText(self.notebook_1_pane_1, -1, "Initial path for \ncode generation file dialogs:")
        ...
        label_2_copy_1 = wx.StaticText(self.notebook_1_pane_1, -1, "Number of buttons per row\nin the main palette")
