...
class CodeProperty(widget_properties.TextProperty):
    def __init__(self, owner, name='extracode'):
        ...
        widget_properties.TextProperty.__init__(self, owner, name, None, True, multiline=True)
    ...
    def display(self, parent):
        ...
        label = wx.lib.stattext.GenStaticText(parent, wx.ID_ANY, _('Extra code for this widget'))
        self._enabler = wx.CheckBox(parent, self.id + 1, '')
        tooltip = """\
You can use this property to add some extra code to that generated by wxGlade.

Please note that you should use this ability only if you have the "Overwrite existing sources" option set."""
