# -*- coding: ISO-8859-15 -*-
#
# generated by wxGlade 1.1.0pre on Sun May  9 14:11:23 2021
#
...
class wxGladePreferencesUI(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        label_4 = wx.StaticText(self.notebook_1_pane_1, wx.ID_ANY, _("Tree"))
        label_4.SetToolTipString(_("Enter scale factor"))
        grid_sizer_1.Add(label_4, 0, wx.ALIGN_CENTER_VERTICAL, 0)

        self.font_scale_tree = wx.SpinCtrlDouble(self.notebook_1_pane_1, wx.ID_ANY, initial=1.0, min=0.0, max=5.0)
        self.font_scale_tree.SetToolTipString(_("Enter scale factor"))
