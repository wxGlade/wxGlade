# -*- coding: ISO-8859-15 -*-
#
# generated by wxGlade 0.9.0 on Wed Mar 20 20:50:10 2019
#
...
class wxGladePreferencesUI(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.show_palette_icons = wx.CheckBox(self.notebook_1_pane_1, wx.ID_ANY, _("Show icons"))
        self.show_palette_labels = wx.CheckBox(self.notebook_1_pane_1, wx.ID_ANY, _("Show labels"))
    ...
    def __do_layout(self):
        ...
        sizer_8 = wx.StaticBoxSizer(wx.StaticBox(self.notebook_1_pane_1, wx.ID_ANY, _("Palette Panel")), wx.HORIZONTAL)
        ...
        sizer_3.Add(sizer_8, 0, wx.EXPAND | wx.LEFT | wx.TOP, 6)
