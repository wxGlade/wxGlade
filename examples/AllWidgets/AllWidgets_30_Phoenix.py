...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Mon Feb  3 22:09:47 2025
#
...
class All_Widgets_Frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        label_15 = wx.StaticText(self.notebook_1_wxDatePickerCtrl, wx.ID_ANY, _("wxDirPickerCtrl:"))
        sizer_17.Add(label_15, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)

        self.dirpicker_ctrl_1 = wx.DirPickerCtrl(self.notebook_1_wxDatePickerCtrl, wx.ID_ANY, "", _("Select folder"), style=wx.DIRP_SMALL | wx.DIRP_USE_TEXTCTRL)
        sizer_17.Add(self.dirpicker_ctrl_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        label_16 = wx.StaticText(self.notebook_1_wxDatePickerCtrl, wx.ID_ANY, _("wxFilePickerCtrl:"))
        sizer_17.Add(label_16, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)

        self.filepicker_ctrl_1 = wx.FilePickerCtrl(self.notebook_1_wxDatePickerCtrl, wx.ID_ANY, "", _("Select file"), _("Text files (*.txt)|*.txt|All files|*.*"), style=wx.FLP_SMALL | wx.FLP_USE_TEXTCTRL)
        sizer_17.Add(self.filepicker_ctrl_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
