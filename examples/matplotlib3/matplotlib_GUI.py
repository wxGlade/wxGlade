...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.button_pick_delete = wx.ToggleButton(self.notebook_3_pane_1, wx.ID_ANY, "Delete")
    ...
    def __set_properties(self):
        ...
        self.button_pick_delete.SetMinSize((40, -1))
        self.button_pick_delete.SetToolTip("When mouse action \"Pick\" is selected: delete any clicked item")
        self.button_multicursor.SetToolTip("Show multi cursor\nnot yet implemented")
    ...
    def __do_layout(self):
        ...
        sizer_13.Add(self.text_cursor_xy_pixel, 2, 0, 0)
        sizer_13.Add(self.text_cursor_xy_value, 2, 0, 0)
        sizer_13.Add((20, 20), 1, wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 0)
        ...
        sizer_13.Add(self.choice_mouse_action, 0, 0, 0)
        ...
        sizer_13.Add(self.button_zoom_hist_home, 0, 0, 0)
        sizer_13.Add(self.button_zoom_hist_back, 0, 0, 0)
        sizer_13.Add(self.button_zoom_hist_forward, 0, 0, 0)
        sizer_13.Add(self.button_autoscale, 0, wx.LEFT, 4)
        ...
        sizer_13.Add(self.text_picked, 4, 0, 0)
        sizer_13.Add(self.button_pick_delete, 0, wx.LEFT, 8)
        sizer_13.Add((20, 20), 1, wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 0)
        sizer_13.Add(self.button_multicursor, 0, wx.LEFT, 8)
        ...
        sizer_12.Add(self.choice_canvas_size, 0, 0, 0)
        ...
        sizer_12.Add(self.choice_subplots, 0, 0, 0)
        ...
        sizer_3.Add(self.choice_subplot, 0, 0, 0)
        ...
        sizer_5.Add(self.button_draw_line, 0, 0, 0)
        ...
        sizer_18.Add(self.combo_box_colour, 0, 0, 0)
        ...
        sizer_18.Add(self.combo_box_line_width, 0, 0, 0)
        ...
        sizer_18.Add(self.choice_line_style, 0, 0, 0)
