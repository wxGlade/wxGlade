...
# $Id: font_dialog.py,v 1.7 2006/12/02 10:49:57 agriggio Exp $
...
class wxGladeFontDialog(wx.Dialog):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.label_2_copy = wx.StaticText(self, -1, "Family:")
        self.label_3_copy = wx.StaticText(self, -1, "Style:")
        self.label_4_copy = wx.StaticText(self, -1, "Weight:")
        ...
        self.label_1 = wx.StaticText(self, -1, "Size in points:")
        self.point_size = wx.SpinCtrl(self, -1, "", min=0, max=100)
        self.underline = wx.CheckBox(self, -1, "Underlined")
        self.font_btn = wx.Button(self, -1, "Specific font...")
