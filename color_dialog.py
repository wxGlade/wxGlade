...
# $Id: color_dialog.py,v 1.8 2006/11/21 22:54:16 dinogen Exp $
...
class wxGladeColorDialog(wx.Dialog):
    def __init__(self, colors_dict):
        ...
        self.use_sys_color = wx.RadioButton(self.panel_1, -1, "System colour",
                                           style=wx.RB_SINGLE)
        self.sys_color = wx.ComboBox(self.panel_1, -1, choices=choices,
                                    style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.use_chooser = wx.RadioButton(self.panel_1, -1, "Custom colour",
                                         style=wx.RB_SINGLE)
