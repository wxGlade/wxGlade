...
class BaseLanguageMixin(StylesMixin):
    ...
    arg_sep = ', '           # Separator between arguments of a function call
    class_sep = ''           # Separator between the hierarchical elements of a class
...
class BaseWidgetWriter(StylesMixin, BaseCodeWriter):
    ...
    def is_class_member(self, name):
        """\
        True, if the name looks like a class (contains L{BaseLanguageMixin.class_sep}).

        @see: L{BaseLanguageMixin.class_sep}
        @rtype: bool
        """
        return bool(self.class_sep and self.class_sep in name)
