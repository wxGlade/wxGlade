...
class BaseLanguageMixin(object):
    ...
    def cn_f(self, flags, styles=None):
        ...
        if styles:
            ...
            flags = self._combine_styles(flags, styles)
    ...
    def _combine_styles(self, flags, styles):
        """\
...
class BaseWidgetCodeWriter(BaseCodeWriter):
    """\
...
class CppWidgetCodeWriter(CppMixin, BaseWidgetCodeWriter):
    """\
...
class LispWidgetCodeWriter(LispMixin, BaseWidgetCodeWriter):
    """\
...
class PerlWidgetCodeWriter(PerlMixin, BaseWidgetCodeWriter):
    """\
...
class PythonWidgetCodeWriter(PythonMixin, BaseWidgetCodeWriter):
    """\
