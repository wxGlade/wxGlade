...
class ClassLines(BaseClassLines):
    ...
    @ivar done:   If True, the code for this class has already been generated
    """
    def __init__(self):
    ...
    if previous_source is not None:
        ...
        for tag in tags:
            ...
            previous_source.content = previous_source.content.replace(tag[0],
                                                                      comment)
        tags = re.findall(
            '#<%swxGlade event_handlers \w+>' % nonce,
            previous_source.content
            )
        for tag in tags:
