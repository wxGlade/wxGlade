...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 894e98ab3259+ on Thu Jan 23 20:34:33 2014
#
...
class UIBugDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.tc_howto_report = wx.TextCtrl(self.notebook_1_pane_1, wx.ID_ANY, _(u"Writing a helpful bug report is easy if you follow some hints. The items below should help you to integrate useful information. They are not an absolute rule - it's more like a guideline.\n\n- What did you? May you want to include a screenshot.\n- What do you want to happen?\n- What actually happened?\n- Provide a short example to reproduce the issue.\n- Include the internal error log file %(log_file)s always.\n\nPlease open a new bug in the wxGlade bug tracker http://sourceforge.net/p/wxglade/bugs/.\nAlternatively you can send the bug report to the wxGlade mailing list wxglade-general@lists.sourceforge.net. Keep in mind that you need a subscription for sending emails to this mailing list."), style=wx.TE_MULTILINE | wx.TE_READONLY)
    ...
    def __do_layout(self):
        ...
        sizer_2.Add(self.btn_copy, 0, wx.ALL | wx.ALIGN_RIGHT, 5)
        sizer_2.Add(self.btn_ok, 0, wx.ALL | wx.ALIGN_RIGHT, 5)
