...
# $Id: perl_codegen.py,v 1.1 2003/06/23 21:28:58 crazyinsomniac Exp $
#
...
class PerlCodeGenerator:
    def get_code(self, obj):
        ...
        init.append('$self->{%s} = %s->new(%s, %s, %s, wxDefaultPosition, wxDefaultSize, %s);\n' %
                    (obj.name, obj.klass.replace('wx','Wx::',1), parent, id, g_range, style))
