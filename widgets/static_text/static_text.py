...
class EditStaticText(ManagedBase, EditStylesMixin):
    ...
    def create_widget(self):
        ...
        #self.widget = wx.lib.stattext.GenStaticText(self.parent_window2, wx.ID_ANY, self.label)
        self.widget = wx.StaticText(self.parent_window2, wx.ID_ANY, self.label, style=self.style)
