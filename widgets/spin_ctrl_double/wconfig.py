...
config = {
    ...
    'style_defs': {
        ...
        'wxALIGN_RIGHT': {
            'desc': _('SSame as wxTE_RIGHT for wxTextCtrl: the text is right aligned (this is the default).'),
            'supported_by': ('wx3',),
        },
        'wxTE_PROCESS_ENTER': {
        ...
        'wxTE_PROCESS_TAB': {
            'desc': _('The control will receive wxEVT_CHAR events for TAB pressed - normally, TAB is used for passing '
                      'to the next control in a dialog instead. For the control created with this style, you can '
                      'still use Ctrl-Enter to pass to the next control from the keyboard.'),
        },
        'wxTE_MULTILINE': {
            'desc': _('The text control allows multiple lines. If this style is not specified, line break characters '
        ...
        'wxTE_RICH': {
            'desc': _('Use rich text control under Win32, this allows to have more than 64KB of text in the control '
                      'even under Win9x. This style is ignored under other platforms.'),
        },
        'wxTE_RICH2': {
        ...
        'wxTE_AUTO_URL': {
            'desc': _('Highlight the URLs and generate the wxTextUrlEvents when mouse events occur over them. '
                      'This style is only supported for wxTE_RICH Win32 and multi-line wxGTK2 text controls.'),
        },
        'wxTE_NOHIDESEL': {
            'desc': _("By default, the Windows text control doesn't show the selection when it doesn't have focus - "
        ...
        'wxTE_NO_VSCROLL': {
            'desc': _('For multiline controls only: vertical scrollbar will never be created. This limits the amount '
                      'of text which can be entered into the control to what can be displayed in it under MSW but '
