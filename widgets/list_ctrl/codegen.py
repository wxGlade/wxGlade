...
def python_code_generator(obj):
    """\
    function that generates python code for wxListCtrl objects.
    """
...
def cpp_code_generator(obj):
    """\
    function that generates C++ code for wxListCtrl objects.
    """
...
def initialize():
    ...
    if pygen:
        pygen.add_widget_handler('wxListCtrl', python_code_generator)
    cppgen = common.code_writers.get('C++')
    if cppgen:
        cppgen.add_widget_handler('wxListCtrl', cpp_code_generator,
