...
class EditSearchCtrl(ManagedBase, EditStylesMixin):
    ...
    def create_widget(self):
        value = self.value
        self.widget = wx.SearchCtrl(self.parent_window2, wx.ID_ANY, value=value, style=self.style)
...
def builder(parent, index):
    ...
    name = parent.toplevel_parent.get_next_contained_name('search_ctrl_%d')
    with parent.frozen():
